...
(define-templated-dispatch 2m* (a b)
  :ignore-template-types (mat-type vec-type)
  ((mat-type 0) (!2m*) (typecase a
                         #+3d-math-f32 (fmat (mat (mrows a) (mcols b)))
                         #+3d-math-f64 (dmat (dmat (mrows a) (mcols b)))
                         #+3d-math-u32 (umat (umat (mrows a) (mcols b)))
                         #+3d-math-i32 (imat (imat (mrows a) (mcols b))))
   a b)
  ((mat-type #'(matching-vec 0)) (!2m*) (vzero b) a b)
  #+3d-math-f32 ((vec4 matn) (!2m*) (mat4 a) a b)
  #+3d-math-f32 ((vec3 matn) (!2m*) (mat3 a) a b)
  #+3d-math-f32 ((vec2 matn) (!2m*) (mat2 a) a b)
  #+3d-math-f64 ((dvec4 dmatn) (!2m*) (dmat4 a) a b)
  #+3d-math-f64 ((dvec3 dmatn) (!2m*) (dmat3 a) a b)
  #+3d-math-f64 ((dvec2 dmatn) (!2m*) (dmat2 a) a b)
  #+3d-math-i32 ((ivec4 imatn) (!2m*) (imat4 a) a b)
  #+3d-math-i32 ((ivec3 imatn) (!2m*) (imat3 a) a b)
  #+3d-math-i32 ((ivec2 imatn) (!2m*) (imat2 a) a b)
  #+3d-math-u32 ((uvec4 umatn) (!2m*) (umat4 a) a b)
  #+3d-math-u32 ((uvec3 umatn) (!2m*) (umat3 a) a b)
  #+3d-math-u32 ((uvec2 umatn) (!2m*) (umat2 a) a b))
